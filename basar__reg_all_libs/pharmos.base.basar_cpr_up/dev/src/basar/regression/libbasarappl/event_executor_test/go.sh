...
cat > "$LOG_CONFIG_DIR/event_executor_test.cfg" << 'EOF'
...
# Basar Regression Test Runner - AIX 7.2 Compatible
# Test: event_executor_test
# Library: libbasarappl

echo "========================================="
echo "  Building: event_executor_test"
echo "========================================="
...
if [ $? -eq 0 ]; then
    ...
    echo ""
    echo "========================================="
    echo "  Running: event_executor_test"
    echo "========================================="
    echo ""
    
    # Check library dependencies
    echo "Library dependencies:"
    ldd ./event_executor_test 2>/dev/null || echo "ldd not available"
    echo ""
