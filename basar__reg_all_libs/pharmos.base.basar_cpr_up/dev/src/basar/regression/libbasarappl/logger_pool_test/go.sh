...
cat > "$LOG_CONFIG_DIR/logger_pool_test.cfg" << 'EOF'
...
# Test: logger_pool_test
# Library: libbasarappl

echo "========================================="
echo "  Building: logger_pool_test"
echo "========================================="
...
if [ $? -eq 0 ]; then
    ...
    echo ""
    echo "========================================="
    echo "  Running: logger_pool_test"
    echo "========================================="
    echo ""
    
    # Check library dependencies
    echo "Library dependencies:"
    ldd ./logger_pool_test 2>/dev/null || echo "ldd not available"
    echo ""
