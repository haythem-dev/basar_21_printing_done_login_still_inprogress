...
cat > "$LOG_CONFIG_DIR/system_event_test.cfg" << 'EOF'
...
# Test: system_event_test
# Library: libbasarappl

echo "========================================="
echo "  Building: system_event_test"
echo "========================================="
...
if [ $? -eq 0 ]; then
    ...
    echo ""
    echo "========================================="
    echo "  Running: system_event_test"
    echo "========================================="
    echo ""
    
    # Check library dependencies
    echo "Library dependencies:"
    ldd ./system_event_test 2>/dev/null || echo "ldd not available"
    echo ""
