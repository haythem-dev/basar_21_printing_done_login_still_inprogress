...
cat > "$LOG_CONFIG_DIR/event_macros_test.cfg" << 'EOF'
...
# Test: event_macros_test
# Library: libbasarappl

echo "========================================="
echo "  Building: event_macros_test"
echo "========================================="
...
if [ $? -eq 0 ]; then
    ...
    echo ""
    echo "========================================="
    echo "  Running: event_macros_test"
    echo "========================================="
    echo ""
    
    # Check library dependencies
    echo "Library dependencies:"
    ldd ./event_macros_test 2>/dev/null || echo "ldd not available"
    echo ""
