...
cat > "$LOG_CONFIG_DIR/definition_struct_test.cfg" << 'EOF'
...
# Test: definition_struct_test
# Library: libbasarguiqt

echo "========================================="
echo "  Building: definition_struct_test"
echo "========================================="
...
if [ $? -eq 0 ]; then
    ...
    echo ""
    echo "========================================="
    echo "  Running: definition_struct_test"
    echo "========================================="
    echo ""
    
    # Check library dependencies
    echo "Library dependencies:"
    ldd ./definition_struct_test 2>/dev/null || echo "ldd not available"
    echo ""
    
    # Run the test
    ./definition_struct_test
    exit_code=$?
