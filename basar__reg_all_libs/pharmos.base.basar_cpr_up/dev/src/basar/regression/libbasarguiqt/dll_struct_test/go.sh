...
cat > "$LOG_CONFIG_DIR/dll_struct_test.cfg" << 'EOF'
...
# Test: dll_struct_test
# Library: libbasarguiqt

echo "========================================="
echo "  Building: dll_struct_test"
echo "========================================="
...
if [ $? -eq 0 ]; then
    ...
    echo ""
    echo "========================================="
    echo "  Running: dll_struct_test"
    echo "========================================="
    echo ""
    
    # Check library dependencies
    echo "Library dependencies:"
    ldd ./dll_struct_test 2>/dev/null || echo "ldd not available"
    echo ""
