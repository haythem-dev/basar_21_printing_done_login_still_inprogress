...
cat > "$LOG_CONFIG_DIR/version_info_test.cfg" << 'EOF'
...
# Test: version_info_test
# Library: libbasarguiqt

echo "========================================="
echo "  Building: version_info_test"
echo "========================================="
...
if [ $? -eq 0 ]; then
    ...
    echo ""
    echo "========================================="
    echo "  Running: version_info_test"
    echo "========================================="
    echo ""
    
    # Check library dependencies
    echo "Library dependencies:"
    ldd ./version_info_test 2>/dev/null || echo "ldd not available"
    echo ""
