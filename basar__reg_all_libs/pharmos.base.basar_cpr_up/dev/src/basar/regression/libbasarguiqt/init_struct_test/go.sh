...
cat > "$LOG_CONFIG_DIR/init_struct_test.cfg" << 'EOF'
...
# Test: init_struct_test
# Library: libbasarguiqt

echo "========================================="
echo "  Building: init_struct_test"
echo "========================================="
...
if [ $? -eq 0 ]; then
    ...
    echo ""
    echo "========================================="
    echo "  Running: init_struct_test"
    echo "========================================="
    echo ""
    
    # Check library dependencies
    echo "Library dependencies:"
    ldd ./init_struct_test 2>/dev/null || echo "ldd not available"
    echo ""
