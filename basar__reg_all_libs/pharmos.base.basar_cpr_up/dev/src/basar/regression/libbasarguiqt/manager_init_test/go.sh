...
cat > "$LOG_CONFIG_DIR/manager_init_test.cfg" << 'EOF'
...
# Test: manager_init_test
# Library: libbasarguiqt

echo "========================================="
echo "  Building: manager_init_test"
echo "========================================="
...
if [ $? -eq 0 ]; then
    ...
    echo ""
    echo "========================================="
    echo "  Running: manager_init_test"
    echo "========================================="
    echo ""
    
    # Check library dependencies
    echo "Library dependencies:"
    ldd ./manager_init_test 2>/dev/null || echo "ldd not available"
    echo ""
