...
cat > "$LOG_CONFIG_DIR/leak_check_test.cfg" << 'EOF'
...
if [ $? -eq 0 ]; then
    ...
    echo ""
    echo "========================================="
    echo "  Running: leak_check_test"
    echo "========================================="
    echo ""
    
    # Check library dependencies
    echo "Library dependencies:"
    ldd ./leak_check_test 2>/dev/null || echo "ldd not available"
    echo ""
