...
cat > "$LOG_CONFIG_DIR/print_error_test.cfg" << 'EOF'
...
# Test: print_error_test
# Library: libbasardebug

echo "========================================="
echo "  Building: print_error_test"
echo "========================================="
...
if [ $? -eq 0 ]; then
    ...
    echo ""
    echo "========================================="
    echo "  Running: print_error_test"
    echo "========================================="
    echo ""
    
    # Check library dependencies
    echo "Library dependencies:"
    ldd ./print_error_test 2>/dev/null || echo "ldd not available"
    echo ""
