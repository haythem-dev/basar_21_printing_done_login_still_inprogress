...
cat > "$LOG_CONFIG_DIR/debug_output_test.cfg" << 'EOF'
...
# Test: debug_output_test
# Library: libbasardebug

echo "========================================="
echo "  Building: debug_output_test"
echo "========================================="
...
if [ $? -eq 0 ]; then
    ...
    echo ""
    echo "========================================="
    echo "  Running: debug_output_test"
    echo "========================================="
    echo ""
    
    # Check library dependencies
    echo "Library dependencies:"
    ldd ./debug_output_test 2>/dev/null || echo "ldd not available"
    echo ""
