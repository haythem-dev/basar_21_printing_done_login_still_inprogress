...
cat > "$LOG_CONFIG_DIR/build_server_test.cfg" << 'EOF'
...
# Test: build_server_test
# Library: libbasardebug

echo "========================================="
echo "  Building: build_server_test"
echo "========================================="
...
if [ $? -eq 0 ]; then
    ...
    echo ""
    echo "========================================="
    echo "  Running: build_server_test"
    echo "========================================="
    echo ""
    
    # Check library dependencies
    echo "Library dependencies:"
    ldd ./build_server_test 2>/dev/null || echo "ldd not available"
    echo ""
