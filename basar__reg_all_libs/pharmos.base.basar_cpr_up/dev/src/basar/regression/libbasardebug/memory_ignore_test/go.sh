...
cat > "$LOG_CONFIG_DIR/memory_ignore_test.cfg" << 'EOF'
...
# Test: memory_ignore_test
# Library: libbasardebug

echo "========================================="
echo "  Building: memory_ignore_test"
echo "========================================="
...
if [ $? -eq 0 ]; then
    ...
    echo ""
    echo "========================================="
    echo "  Running: memory_ignore_test"
    echo "========================================="
    echo ""
    
    # Check library dependencies
    echo "Library dependencies:"
    ldd ./memory_ignore_test 2>/dev/null || echo "ldd not available"
    echo ""
