...
cat > "$LOG_CONFIG_DIR/resultset_test.cfg" << 'EOF'
...
# Test: resultset_test
# Library: libbasardbsql

echo "========================================="
echo "  Building: resultset_test"
echo "========================================="
...
if [ $? -eq 0 ]; then
    ...
    echo ""
    echo "========================================="
    echo "  Running: resultset_test"
    echo "========================================="
    echo ""
    
    # Check library dependencies
    echo "Library dependencies:"
    ldd ./resultset_test 2>/dev/null || echo "ldd not available"
    echo ""
