...
cat > "$LOG_CONFIG_DIR/string_operations.cfg" << 'EOF'
...
echo "========================================="
echo "  Building: string_operations"
echo "========================================="
...
if [ $? -eq 0 ]; then
    ...
    echo ""
    echo "========================================="
    echo "  Running: string_operations"
    echo "========================================="
    echo ""
    
    # Check library dependencies
    echo "Library dependencies:"
    ldd ./string_operations 2>/dev/null || echo "ldd not available"
    echo ""
