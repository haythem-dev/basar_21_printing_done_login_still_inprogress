...
#<BB>
cp -h ${ext_dir}/zlib/lib/debug/*.so*   sharedlib/Debug/ #original cmds commented out
cp -h ${ext_dir}/zlib/lib/release/*.so* sharedlib/Release/ #original cmds commented out
#</BB>

#<BB>
# We need to copy .a files here too
#cp -h ${ext_dir}/zlib/lib/debug/*.a*   sharedlib/Debug/
#cp -h ${ext_dir}/zlib/lib/release/*.a* sharedlib/Release/
#</BB>
